...
const productsData = {
  products: [
    ...
    },
    {
      id: 17,
      name: "Printed Hoodie",
      description: "Soft printed hoodie for kids’ everyday wear.",
      price: 27.99,
      oldPrice: 49.99,
      currency: "USD",
      defaultSize: "8",
    ...
    },
    {
      ...
      description: "Soft cotton pajama set for a cozy night’s sleep.",
      price: 27.99,
      oldPrice: 69.99,
      currency: "USD",
      defaultSize: "2T",
    ...
    },
    {
      ...
      description: "Comfortable slip-on flats for girls’ daily wear.",
      price: 29.99,
      oldPrice: 49.99,
      currency: "USD",
      defaultSize: "6",
    ...
    try {
      ...
      try {
        ...
        if (fs.existsSync(localImagePath)) {
          ...
          if (uploadedUrl) {
            ...
            console.warn(`⚠️ Cloudinary returned null for ${product.name}, using local path.`);
          }
        } else {
          console.warn(`⚠️ Local image not found at: ${localImagePath}. Using raw string.`);
        }
      } catch (uploadError) {
      ...
      await prisma.product.create({
        data: {
          ...
          image: cloudUrl, // 👈 Using the uploaded URL (or original string if failed)
          subcategory: product.subcategory,
          rating: Math.ceil(product.rating),
          discount: product.discount,
          oldPrice: product.oldPrice ? Math.ceil(product.oldPrice) : 0, 
          tags: product.tags,
          categoryid: categoryId, // 👈 Correct lowercase id
        },
      });
